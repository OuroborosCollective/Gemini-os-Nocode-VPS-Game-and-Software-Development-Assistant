        ...
        <div className={`app-view lg:w-[320px] shrink-0 ${activeTab === "explorer" ? "flex" : "hidden lg:flex"} flex-col h-full border-r border-stone-200`}>
          ...
          <div className="p-3 bg-purple-50 border-b border-purple-200 shrink-0">
            <div className="flex justify-between items-center mb-2">
              ...
              <button onClick={handleExpandBlueprint} className="text-[9px] font-bold bg-purple-200 text-purple-800 px-2 py-0.5 rounded hover:bg-purple-300 transition-colors shadow-sm" aria-label="Idee erweitern">✨ Expand Idea</button>
            </div>
            <textarea
            ...
            <div className="truncate flex-1">
              ...
              <div className="flex gap-2 items-center">
                ...
                <button
                  ...
                  aria-label="Commit Message generieren"
        ...
        <div className={`app-view lg:w-[320px] shrink-0 ${activeTab === "chat" ? "flex" : "hidden lg:flex"} flex-col h-full border-l border-stone-200`}>
          ...
          <div className="p-3 bg-stone-50 border-t border-stone-200 shrink-0">
            <div className="flex gap-2">
              ...
              />
              <button onClick={handleSendChat} className="bg-purple-600 text-white px-3 py-1.5 rounded text-[11px] font-bold hover:bg-purple-700 transition-colors shadow-sm" aria-label="Nachricht senden">✨</button>
            </div>
          </div>
        </div>
      </main>
